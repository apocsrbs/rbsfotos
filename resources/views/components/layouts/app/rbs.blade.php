        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                <a href="{{ route('home') }}" class="flex justify-center">
                    <img src="{{ asset('assets/images/logo.svg') }}" alt="Logo" class="h-16 w-auto dark:invert drop-shadow-lg ms-10 mb-5">
                </a>
                ...
                <div class="flex space-x-10 justify-center items-center mb-14">
                    <a href="https://www.facebook.com/burowfotos" target="_blank" class="block text-white transition-all duration-500 hover:text-indigo-400" aria-label="Facebook">
                    ...
                    <a href="https://www.instagram.com/rene.soerensen/" target="_blank" class="block text-white transition-all duration-500 hover:text-indigo-400" aria-label="Instagram">
                ...
                <span class="text-center block">© <a href="{{ route('home') }}" class=" text-white hover:text-indigo-400">RBS Fotos</a> 2025</span>
            </div>
        </div>
    </footer>
<script>

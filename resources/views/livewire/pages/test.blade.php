<x-layouts.app.test>
    <!-- ALVA -->
    <div id="bg1" class="min-h-screen w-full bg-cover bg-center bg-no-repeat bg-image bg-fixed" style="background-image: url('{{ asset('assets/images/backgrounds/_BS_7141.webp') }}')">
    ...
    <!-- AUDI -->
    <div id="bg2" class="min-h-screen w-full bg-cover bg-center bg-no-repeat bg-image bg-fixed hidden md:block" style="background-image: url('{{ asset('assets/images/backgrounds/AudiA5-HøfdeQ-facebook.webp') }}')">
    ...
    <!-- CYKLING -->
    <div id="bg3" class="min-h-96 max-h-96 w-full bg-cover bg-no-repeat bg-image bg-fixed bg-[center_0%] sm:bg-[90%_center]" 
    ...
    <!-- LIVA -->
    <div id="bg4" class="min-h-screen w-full bg-cover bg-center bg-no-repeat bg-image bg-fixed" style="background-image: url('{{ asset('assets/images/backgrounds/_BS_7146.webp') }}')">

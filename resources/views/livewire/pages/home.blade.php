<x-layouts.app.rbs>
    ...
    <!-- AUDI -->
    <div id="bg2" class="min-h-screen w-full bg-cover bg-center bg-no-repeat bg-image bg-local lg:bg-fixed hidden md:block" style="background-image: url('{{ asset('assets/images/backgrounds/AudiA5-HøfdeQ-facebook.webp') }}')">
    ...
    <!-- CYKLING -->
    <div id="bg3" class="min-h-96 max-h-96 w-full bg-cover bg-no-repeat bg-image bg-local lg:bg-fixed bg-[center_0%] sm:bg-[90%_center]" 
